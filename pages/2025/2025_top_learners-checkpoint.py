...
img_contact_form = Image.open("pages/2024/banner.jpg")
...
#Import data
df = pd.read_excel("pages/2025/2026 Top Learner High School- Main 20250210.xlsx", sheet_name="Other Universities")
hs = pd.read_excel("pages/2024/2026 Top Learner High School- Main 20250210.xlsx", sheet_name="University Applications")
