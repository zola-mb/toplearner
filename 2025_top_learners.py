...
#img_contact_form = Image.open("assets/images/banner.jpg")
...
#Import data
excel_file = DATA / "2026 Top Learner High School- Main 20250210.xlsx"
df = pd.read_excel(excel_file, sheet_name="Main Sheet")
hs = pd.read_excel(excel_file, sheet_name="University Applications")
