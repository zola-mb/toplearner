...
#Import data
excel_file = DATA / "2025 Top Learner  High School - Main 20240912 (4).xlsx"
df = pd.read_excel(excel_file, sheet_name="Other Universities")
hs = pd.read_excel(excel_file, sheet_name="High School")
